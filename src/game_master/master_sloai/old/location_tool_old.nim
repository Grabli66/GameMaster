...
proc createLocationDescription*(ai: ApiWithModels, location: Location, maxTokens: int) : string =    
    ...
    let completeResult = ai.api.complete(types.gemma34bIt, systemPrompt, userPrompt, some(CompleteOptions(
